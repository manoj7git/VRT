...
public class assetDetailsTest extends BaseClass {
	...
	public void AssetCreationSetup() throws InterruptedException, IOException {
		 ...
		 * UserManagementPage.FirstUserCreation("User1", getUN("adminFull"),
		 * getPW("adminFull"), getPW("adminFull"), "FullAdmin", "12345678",
		 * "abc@gmail.com"); MainHubPage = LoginPage.Login(getUN("adminFull"),
		 ...
		 * UserLoginPopup(getUN("adminFull"), getPW("adminFull")); MainHubPage =
